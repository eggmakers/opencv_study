...
new_img1 = butterworth_bandpass_filter(img, D0 = 6, W = 10, n=1)
new_img2 = butterworth_bandpass_filter(img, D0 = 15, W = 10, n=1)
new_img3 = butterworth_bandpass_filter(img, D0 = 25, W = 10, n=1)

new_img_1 = gaussian_bandpass_filter(img,D0=6,W = 10)
new_img_2 = gaussian_bandpass_filter(img,D0=15,W = 10)
new_img_3 = gaussian_bandpass_filter(img,D0=25,W = 10)

# 显示原始图像和带通滤波处理图像
plt.figure("Ideal_bandpass")
...
# 显示原始图像和带通滤波处理图像
plt.figure("butterworth_bandpass")
title=['Source Image','D0=6','D0=15','D0=25']
